module.exports = (io) => {
    io.on("connection", (socket) => {
        ...
        socket.on("search-battlelog", (username) => {
            ...
            // get all battlelog of target user
...
function updateBattlelog(roomstate, winner) {
    ...
    // insert new record to battlelog
    ...
    // check whether the game is ranked
    if(roomstate.ranked) {
